package com.upbest.intercepter;
...
//		Puser user = (Puser) request.getSession().getAttribute(ResultCode.ADMIN_LOGIN_INFO);
//		if (user == null) {// 如果没有登录或登录超时
//			String gourl = "http://"+request.getServerName()+":"+request.getServerPort() + "/manager/login";
