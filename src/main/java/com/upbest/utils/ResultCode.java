...
/*	1000	ERROR	错误
	...
	1016	TOKEN_EXIST	用户TOKEN存在
	1007	TOKEN_ALREADY_EXPIRE	
	1008    NICK_NAME_EXIST 用户昵称已经被使用
	1009    USER_NAME_LENGTH 用户名称长度
	1010    ERROR_PARAM 参数错误
	1013    VERIFICATIONCODE_NOT_MATCH 验证码不匹配
	1014    ERROR_PHONE_NUMBER 手机号格式不正确
	401     ACCESS_TOKEN_ERROR token不匹配*/
	...
	public static Integer TOKEN_EXIST = 1016;
	...
	public static final Integer VERIFICATIONCODE_NOT_MATCH = 1013;
	public static final Integer ERROR_PHONE_NUMBER = 1014;
	
	public static final Integer RESP_LOGINERROR_AUTHCODE = 2003;
	public static final Integer RESP_ERROR_SESSIONILLEGAL = 2004;
	
	public static final Integer ACCESS_TOKEN_ERROR = 401;
}
