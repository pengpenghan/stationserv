...
function(a) {
    ...
    b.prototype.buildDots = function() {
        var c, d, b = this;
        if (b.options.dots === !0 && b.options.autoplaySpeed == 5000 && b.slideCount >= b.options.slidesToShow) {
        	
//            for (d = '<div class="col-xs-2"> <ul class="slick-dots">', c = 0; c <= b.getDotCount(); c += 1) d += "<li>" + b.options.customPaging.call(this, b, c) + "</li>";
//            d += "</ul></div>",
        	var specialevents_photo = $("#specialevents_photo").val().split(",");
        	var specialevents_name = $("#specialevents_name").val().split(",");
        	var specialevents_id = $("#specialevents_id").val().split(",");
        	var str = "";
    		for(var i=0;i<specialevents_name.length;i++){
    			
    			str +='<li class=""><a>'+specialevents_name[i]+'</a></li>';
    		}
        		
        	d='<div class="col-xs-2"> <ul class="slick-dots" style="display: block;">'
        		//+'<li class=""><a>群众路线</a></li>'
    	  	    //+'<li class=""><a>三严三实</a></li>'
    	  	    //+'<li class=""><a>身边最美</a></li>'
        		+str
    	  	    +'</ul></div>',
    	  	
    	  
            b.$dots = a(d).insertBefore(b.$slider),
            b.$dots.find("li").first().addClass("slick-active")
        }
        if (b.options.dots === !0 && b.options.autoplaySpeed != 5000  && b.slideCount > b.options.slidesToShow  && b.options.slidesToShow == 1) {
        	
            for (d = '<ul class="slick-dots my-slick-dots">', c = 0; c <= b.getDotCount(); c += 1) d += "<li>" + b.options.customPaging.call(this, b, c) + "</li>";
             d += "</ul>",
         	
     	  	
     	  
             b.$dots = a(d).insertAfter(b.$slider),
             b.$dots.find("li").first().addClass("slick-active")
         }
    },
    ...
    b.prototype.setValues = function() {
        ...
        a.slideWidth = Math.ceil(a.listWidth / a.options.slidesToShow+1)
    },
