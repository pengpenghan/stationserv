...
function __callbackGetChildren(jsonObject)
{
	...
	if( chs && chs.length > 0 )
	{
		...
		for(var i = 0 ; i < len; i++ )
		{
			...
			var item = new WebFXTreeItem(child.title,act);
...
var webFXTreeConfig = {
	rootIcon        : getScriptPath() + 'images/xtree/base.gif',
	openRootIcon    : getScriptPath() + 'images/xtree/base.gif',
	folderIcon      : getScriptPath() + 'images/xtree/folder.gif',
	openFolderIcon  : getScriptPath() + 'images/xtree/folderopen.gif',
	fileIcon        : getScriptPath() + 'images/xtree/page.gif',
...
WebFXTree.prototype.search = function(nodeText)
{
...
WebFXTreeItem.prototype.setTag = function(sTag) {
	this.tag = sTag;
}

WebFXTreeItem.prototype.getTag = function() {
	return this.tag;
}
...
WebFXTreeItem.prototype.setCheckNodeType = function() {
	this.isCheck = true;
}

WebFXTreeItem.prototype.isCheckNodeType = function() {
	return this.isCheck;
}
...
WebFXTreeItem.prototype.handleCheckBox = function()
{
	var str = "";
	if( this.isCheck )
	{
...
WebFXTreeItem.prototype.handleParentCheckBox = function()
{
	var str = "";
	if( this.isCheck )
	{
...
WebFXTreeItem.prototype.addSelectNodes = function (chked)
{
...
WebFXTreeItem.prototype.onCheck = function (srcNode, checkCtrl)
{
